...
export function Header() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative z-[70] mx-auto flex max-w-7xl items-center justify-between px-4 transition-all duration-300 sm:px-6 lg:px-8",
          scrolled ? "py-3" : "py-4",
        )}
      >
        <MantraviLogo
        ...
        <button
          type="button"
          className={cn(
            "relative z-[70] -mr-1 rounded-lg p-2 lg:hidden",
      ...
      <div
        ...
        className={cn(
          "fixed top-0 right-0 z-[60] flex h-[100dvh] w-full max-w-[min(100vw,20rem)] flex-col shadow-2xl transition-transform duration-300 ease-out lg:hidden",
